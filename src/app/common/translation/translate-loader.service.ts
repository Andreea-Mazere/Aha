...
export class TranslateLoaderService implements TranslateLoader {
  getTranslation(lang: string): Observable<any> {
    ...
    return Observable.from([{
      ...
      passwordChangeForm_MustBeLoggedOnForThisOperation: "You must be logged on to change your password!",
      ...
      'loginForm_auth/network-request-failed': commonMessages.networkRequestFailed
    }]);
  }
} 
